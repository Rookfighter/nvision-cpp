...
namespace cve
{
    ...
    class FASTDetector : public FASTDetectorBase<Scalar, Mode>
    {
    public:
    ...
    public:
        ...
        FASTDetector(const Scalar threshold,
            ...
            : FASTDetectorBase<Scalar, Mode>(threshold, minDist, maxFeatures, useSuppresion)
        { }
            ...
            Matrix &keypoints) const
        {
            ...
            if(this->useSuppression_ || (this->maxFeatures_ > 0 && static_cast<Index>(corners.size()) > this->maxFeatures_))
            {
                ...
                this->computeScoreMatrix(img, corners, score);
            }
            ...
            if(this->useSuppression_)
            {
                ...
                this->nonMaximaSuppression(score, corners);
            }
