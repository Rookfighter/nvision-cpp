...
TEMPLATE_TEST_CASE("ORB descriptor", "[feature]", nvision::float32, nvision::float64)
{
    ...
    using FeatureMatrix = typename ORBDescriptor<Scalar>::FeatureMatrix;
    using DescriptorMatrix = typename ORBDescriptor<Scalar>::DescriptorMatrix;
    ...
    {
        BasePatternMatrix pattern(4, 32);
        ...
        ORBDescriptor<Scalar> descriptor;
