...
TEST_CASE("central_differences_filter")
{
    ...
    SECTION("x-derivative")
    {
        ...
        gradExp(0, 0, 0) = 0; gradExp(0, 1, 0) = 125;  gradExp(0, 2, 0) = 0;    gradExp(0, 3, 0) = 0;
        gradExp(1, 0, 0) = 0; gradExp(1, 1, 0) = -255; gradExp(1, 2, 0) = 125;  gradExp(1, 3, 0) = 0;
        gradExp(2, 0, 0) = 0; gradExp(2, 1, 0) = 0;    gradExp(2, 2, 0) = -255; gradExp(2, 3, 0) = 0;
        gradExp(3, 0, 0) = 0; gradExp(3, 1, 0) = 130;  gradExp(3, 2, 0) = 125;  gradExp(3, 3, 0) = 0;
    ...
    SECTION("y-derivative")
    {
        ...
        gradExp(0, 0, 0) = 0;    gradExp(0, 1, 0) = 0; gradExp(0, 2, 0) = 0;   gradExp(0, 3, 0) = 0;
        gradExp(1, 0, 0) = 255;  gradExp(1, 1, 0) = 0; gradExp(1, 2, 0) = 130; gradExp(1, 3, 0) = -255;
        gradExp(2, 0, 0) = -130; gradExp(2, 1, 0) = 0; gradExp(2, 2, 0) = 255; gradExp(2, 3, 0) = 0;
        gradExp(3, 0, 0) = 0;    gradExp(3, 1, 0) = 0; gradExp(3, 2, 0) = 0;   gradExp(3, 3, 0) = 0;
