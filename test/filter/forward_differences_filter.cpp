...
TEST_CASE("forward_differences_filter")
{
    ...
    gradExpX(0, 0, 0) = 255;  gradExpX(0, 1, 0) = -130; gradExpX(0, 2, 0) = 130;  gradExpX(0, 3, 0) = -130;
    gradExpX(1, 0, 0) = -255; gradExpX(1, 1, 0) = 0;    gradExpX(1, 2, 0) = 125;  gradExpX(1, 3, 0) = -125;
    gradExpX(2, 0, 0) = 0;    gradExpX(2, 1, 0) = 0;    gradExpX(2, 2, 0) = -255; gradExpX(2, 3, 0) = 255;
    gradExpX(3, 0, 0) = -125; gradExpX(3, 1, 0) = 255;  gradExpX(3, 2, 0) = -130; gradExpX(3, 3, 0) = 130;

    Imagef gradExpY(4, 4, 1);
    gradExpY(0, 0, 0) = 255;  gradExpY(0, 1, 0) = -255; gradExpY(0, 2, 0) = -125; gradExpY(0, 3, 0) = -130;
    gradExpY(1, 0, 0) = 0;    gradExpY(1, 1, 0) = 255;  gradExpY(1, 2, 0) = 255;  gradExpY(1, 3, 0) = -125;
    gradExpY(2, 0, 0) = -130; gradExpY(2, 1, 0) = -255; gradExpY(2, 2, 0) = 0;    gradExpY(2, 3, 0) = 125;
